...
namespace ApibookingAdministrator.Models
{
    ...
    public partial class HOSTING_MANAGEREntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> SP_VALIDATE_TOKEN(string tOKEN)
        {
            var tOKENParameter = tOKEN != null ?
                new ObjectParameter("TOKEN", tOKEN) :
                new ObjectParameter("TOKEN", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("SP_VALIDATE_TOKEN", tOKENParameter);
        }
